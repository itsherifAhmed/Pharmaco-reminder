...
import 'infastructure/data_sources/local/local_notifications_data_source/local_notifications_data_source_impl.dart';
...
class AppConfigs {
  ...
  static Future<void> config() async {
    runZonedGuarded<Future<void>>(() async {
      ...
      LocalNotificationsDataSourceImpl localNotificationsDataSourceImpl=LocalNotificationsDataSourceImpl();
      localNotificationsDataSourceImpl.initializeNotification();
      _buildFimberTree();
